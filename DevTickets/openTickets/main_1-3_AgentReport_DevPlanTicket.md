...
> `main_1-3`: [Autofix](main_1-1_Autofix_DevPlanTicket.md) is queued first
...
> kept behind [AgentContract](main_1-2_AgentContract_DevPlanTicket.md), for
...
> Kept behind AgentContract, whose pair rule and data contract this
> ticket's own abstract says it depends on settling first.
