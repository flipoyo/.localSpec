...
> **Milestone M4** of [MemoryArchitecture](memory-dev_1-1_MemoryArchitecture_DevPlanTicket.md).
> From the owner's `.localSpec/DevTickets/archive/.closedUserTicket/20260912_memorySpecs.md`: *"As cli has
