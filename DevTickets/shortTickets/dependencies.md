all dependencies must be listed in lgr and their version. They are of multiple type:
os : environnement or/and kernel 
cgitsync version
python + packages (including version ???)
software + version pixi, git, dvc, git-lfs, gh, 
