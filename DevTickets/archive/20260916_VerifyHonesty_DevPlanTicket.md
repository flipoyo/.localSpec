...
- **Ten citations of `.localSpec/DevTickets/IsolationPlan.md`**, a file that does not
  ...
  `.localSpec/DevTickets/archive/20260828_Isolation_DevPlanTicket.md` — and if a schema
